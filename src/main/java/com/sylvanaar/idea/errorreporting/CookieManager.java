...
public class CookieManager {
    private final Map<String, HashMap<String, HashMap<String, String>>> store;
     ...
     * of the open java.net.URLConnection.
     *
     ...
     * unexpired cookies that match the path or sub-paths for thi underlying URL
     *
    ...
    public void setCookies(URLConnection conn) throws IOException {
		...
		HashMap<String, HashMap<String, String>> domainStore = store.get(domain);
